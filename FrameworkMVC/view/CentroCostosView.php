...
<html lang="es">
     <head>
         <meta charset="utf-8"/>
        <title>Centro Costos - Contabilidad 2016</title>
      ...
      <body class="cuerpo">
       ...
       <?php include("view/modulos/menu.php"); ?>
        ...
        <div class="row" style="background-color: #FAFAFA;">
            ...
            <form id="form-centro-costos" action="<?php echo $helper->url("CentroCostos","InsertaCentroCostos"); ?>" method="post" class="col-lg-6">
            <br>	
	        ...
	        <div class="well">
            <h4 style="color:#ec971f;">Registrar Centro de Costos</h4>
            <hr/>
	        <div class="row">
            ...
            <form action="<?php echo $helper->url("CentroCostos","index"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
     		<br>
     		<div class="well">  
            <h4 style="color:#ec971f;">Centro de Costos Registrados</h4>
