                  ...
                  <table class="table table-hover">
					...
					while($row = pg_fetch_array($query)){
						...
						<tr>
							...
							<a href="/FrameworkMVC/view/ireports/ContComprobanteEgresosReport.php?id_ccomprobantes=<?php echo $id_ccomprobantes; ?>"onclick="window.open(this.href, this.target, ' width=1000, height=800, menubar=no');return false"><i class="glyphicon glyphicon-edit"></i></a>
							<a href="#" class='btn btn-default' onclick="eliminar('<?php echo $id_ccomprobantes; ?>')"><i class="glyphicon glyphicon-trash"></i> </a>
							</span>
							</td>
